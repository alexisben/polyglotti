...
function render_pannel() {
    ...
    if(isset($_FILES['csv']['tmp_name']) && isset($_POST['submit']))
    {
    ...
    <div class="wrap theme-option-page">
        ...
        <form id="lesson-options" action="" method="post" enctype="multipart/form-data">
            ...
            <input id='upload_button' type='submit' name='submit' class='button' value='<?php _e('Envoyer', 'lesson'); ?>' />
        </form>
    </div>
